...
EditText stdName,stdEnroll, jG,jA,nG,nA,mG,mA,wG,wA,aG,aA;
    ...
    public void insertMethod(View view){
        ...
        ||aA.getText().toString().isEmpty()) {
            Toast.makeText(Attendance.this, "please enter required fields", Toast.LENGTH_LONG).show();
        } else


            new Attendance.ConnectToRemote().execute("http://zulkarnainfaizan.000webhostapp.com/ProMajor3D/AndroidPhp/insertdata.php",
...
//        setContentView(webView);
        webView.loadUrl("http://zulkarnainfaizan.000webhostapp.com/ProMajor3D/php/retrievedata.php");
